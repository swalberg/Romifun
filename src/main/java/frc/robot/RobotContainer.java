...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        ...
        new Pose2d(1.5, 0.6, new Rotation2d(0)),
        config);
    ...
    return new InstantCommand(() -> m_romiDrivetrain.resetEncoders()).andThen(ramseteCommand).andThen(() -> m_romiDrivetrain.tankDriveVolts(0, 0));
  }
}
